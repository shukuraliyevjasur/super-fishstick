...
[SECURITY_AUDIT.md](2026-08-02-security-audit.md), [LAUNCH_REVIEW.md](2026-08-02-launch-review.md).
Project background: [HANDOFF.md](../operations/handbook.md).
...
[DECISIONS.md](../product/decisions.md). Payment is collected manually for now (customer contacts
...
[DECISIONS.md](../product/decisions.md)). When rails ship, the payment webhook calls the same
...
[DECISIONS.md](../product/decisions.md). Read it before P1 — D2 says not to reuse
