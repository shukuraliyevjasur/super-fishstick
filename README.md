...
For the complete stack — application libraries, the two runtime processes, and the free services this runs on (Vercel, Supabase, Redis Cloud, a GCP always-free VM for the worker, Resend, Meta) — see [docs/stack.md](docs/stack.md).
